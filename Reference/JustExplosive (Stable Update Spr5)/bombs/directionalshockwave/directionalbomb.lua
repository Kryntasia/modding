...
if self.timeractive == true then
  ...
  world.spawnProjectile("directionalbombsonicproj", entity.toAbsolutePosition({ 0, 0 }), entity.id(), self.aim, true, {})
  self.switch = true
  end
  if self.countdown > 0 then
    self.countdown = self.countdown - 1
   else
   world.spawnProjectile("directionalbombsonicpoof", entity.toAbsolutePosition({ 0, 0 }), entity.id(), self.aim, true, {})
   entity.smash()
  end
  end
end